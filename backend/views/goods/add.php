    ...
    ?>
        <div class="tab-div">
            ...
            <div id="tabbody-div">
                ...
                <!-----商品表单------>
                <table width="90%" id="general" align="center" >
                    <tr>
                ...
                <!----详细描述---->
                <table width="90%" id="detail-tab" class="detail" align="center">
                    <tr>
                        <td>
                ...
                <!--其他信息-->
                <table width="90%" id="other-tab"  class="other" align="center">
                    <tr>
                ...
                <!--商品属性-->
                <table width="90%" align="center" id="attribute-tab" class="attribute">
                    <tr id="first-line">
                ...
                <!----商品相册-->
                <table width="90%" id="image-tab" class="image" align="center">
                    <tr>
                        <td>
                            <div id='picture'>
                            </div>
