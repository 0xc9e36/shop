...
<frameset rows="76,*" framespacing="0" border="0">
    ...
    <frameset cols="180,*" framespacing="0" border="0" id="frame-body">
        <frame src="/index.php?r=index/menu" id="menu-frame" name="menu-frame" frameborder="no">
        <frame src="/index.php?r=index/main" id="main-frame" name="main-frame" frameborder="no">
    </frameset>
</frameset>
</head>
<body>
